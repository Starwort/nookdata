...
precacheAndRoute([
    ...
    {url: 'assets/i18n/en/core.json', revision: '70efae'},
    {url: 'assets/i18n/en/critterpedia.json', revision: 'ef4e67'},
    {url: 'assets/i18n/en/service.json', revision: '2f0f55'},
    {url: 'assets/i18n/en/turnips.json', revision: 'e8caf9'},
    {url: 'assets/i18n/fr/core.json', revision: 'd683d3'},
    {url: 'assets/i18n/fr/critterpedia.json', revision: '732a3d'},
    {url: 'assets/i18n/fr/service.json', revision: '6433f4'},
    {url: 'assets/i18n/fr/turnips.json', revision: '22993e'},
    {url: 'assets/i18n/ja/core.json', revision: 'e7e0fa'},
    {url: 'assets/i18n/ja/critterpedia.json', revision: '41d8d8'},
    {url: 'assets/i18n/ja/service.json', revision: '9e26df'},
    {url: 'assets/i18n/ja/turnips.json', revision: '9e26df'},
    {url: 'assets/icons/dark_mode.svg', revision: 'd183ec'},
    {url: 'assets/icons/discord.svg', revision: '0f9acc'},
    {url: 'assets/icons/light_mode.svg', revision: '7fae63'},
